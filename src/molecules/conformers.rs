...
use crate::molecules::{common::MoleculeCommon, small::MoleculeSmall};
...
// Note: `sample_mol_properties_from_md`, which populates `MdSampleData` by running a short MD sim,
// lives in Molchanica. It needs the application's state and scene to build the simulation.
